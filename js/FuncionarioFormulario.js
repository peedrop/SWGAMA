...
function exibir_ocultar() {
    var val = $("#tipo").val();
    var preco = document.getElementById('salario');
    var dtPagamento = document.getElementById('dtPagamento');
    var lbValorTotal = document.getElementById('lbSalario');
    var thPreco = document.getElementById('lbPagamento');
    if (val == 'VOLUNTARIO') {
        $('.ocultar').hide();
        $(preco).hide();
        $(dtPagamento).hide();
...
$("#formFuncionario").validate({
    rules:{
         ...
         cpf:{
            ...
            remote: {
                url: "../controlador/FuncionarioControlador.php?operacao=verificarCpf&idFuncionario=" + $("#idFuncionario").val(),
                type: "post",
                data: {
                    login: function () {
                        return $("#cpf").val();
    ...
    messages:{
        nmFuncionario:{
             ...
             maxlength: "O número máximo de caracteres é 100"
         },
         dtNasc:{
            required: "Obrigatório*"
         },  
         ...
         dtPagamento:{
             min:"A menor data deve ser 1"
         },
         endereco:{
             maxlength: "O número de caracteres é 500",
             minlength: "O número mínimo de caracteres é 3"
         },
         email:{
         ...
         telefone:{
            minlength: "O telefone deve ter 11 digitos",
            required: "Obrigatório*",
         },
         sexo: {
            required: "Obrigatório*"
