...
<html lang="pt">
    <head>
        <title>Tipos de Malha Tabela</title>
        <?php 
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="col-md-5 float-right">
                                    <a class="btn btn-success btn-round float-right" href="../formulario/TipoMalhaFormulario.php">+ Novo Tipo de Malha</a>
                                    ...
                                    <?php
                                        if(isset($_GET["operacao"])=="filtrar"){
                                            echo "<a class='mx-2 btn btn-warning btn-round float-right mr-3' href='TipoMalhaTabela.php'>Limpar filtro</a>";
                                        }
                                    ?>
                                </div>
                                <div class="card-header">
                                    <h5 class="title">Tipos de Malha Tabela</h5>
                                </div>
                                <div class="card-body">
                                        ...
                                        <tbody>
                                            <?php
                                                ...
                                                if(isset($_GET["operacao"])=="filtrar"){							
                                                    ...
                                                    $lista = $tipoMalhaDAO->filtrar($nome);
                                                }else{
                                                    $lista = $tipoMalhaDAO->listar();
                                                }
                                                ...
                                                foreach($lista as $tipoMalha){
                                                    ...
                                                    */
                                                    ...
                                                    $obj_json = json_encode(array(
                                                        "Visualizar Tipo de Malha",
                                                        "Id", $tipoMalha->getIdMalha(), 
                                                    ...
                                                    echo"<tr>";			
                                                    //idMalha
                                                    echo"<td>{$tipoMalha->getIdMalha()}</td>";	
                                                    //nome	
                                                    echo"<td>{$tipoMalha->getNome()}</td>";		
                                                    ...
                                                    href='../formulario/TipoMalhaFormulario.php?operacao=editar&idMalha={$tipoMalha->getIdMalha()}'><i class='material-icons'>
                                                        create</i></a>";
                                                    //botão excluir
                                                    echo"<a class='btn btn-danger btn-simple btn-icon btn-sm'  
                                                    href='../controlador/TipoMalhaControlador.php?operacao=excluir&idMalha={$tipoMalha->getIdMalha()}'>
        ...
        <div class="modal fade" id="modalFiltro" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
		  <div class="modal-dialog" role="document">
			<div class="modal-content">
				<form id="formFiltroTipoMalha" action="TipoMalhaTabela.php?operacao=filtrar" 
					method="post">
