...
<html lang="pt">
    <head>
        <title>Modo de Produção Tabela</title>
        <?php 
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="col-md-5 float-right">
                                    <a class="btn btn-success btn-round float-right" href="../formulario/ModoProdFormulario.php">+ Novo Modo de Produção</a>
                                    ...
                                    <?php
                                        if(isset($_GET["operacao"])=="filtrar"){
                                            echo "<a class='mx-2 btn btn-warning btn-round float-right mr-3' href='ModoProdTabela.php'>Limpar filtro</a>";
                                        }
                                    ?>
                                </div>
                                <div class="card-header">
                                    <h5 class="title">Modo de Produção Tabela</h5>
                                </div>
                                <div class="card-body">
                                        ...
                                        <tbody>
                                            <?php
                                                ...
                                                if(isset($_GET["operacao"])=="filtrar"){							
                                                    ...
                                                    $lista = $modoProdDAO->filtrar($nome);
                                                }else{
                                                ...
                                                foreach($lista as $modoProd){
                                                    ...
                                                    */
                                                    $obj_json = json_encode(array(
                                                        "Visualizar Modo de Produção",
                                                        "Id", $modoProd->getIdModoProd(), 
                                                    ...
                                                    echo"<tr>";			
                                                    //idModoProd
                                                    echo"<td>{$modoProd->getIdModoProd()}</td>";	
                                                    //nome	
                                                    echo"<td>{$modoProd->getNome()}</td>";		
                                                    ...
                                                    href='../formulario/ModoProdFormulario.php?operacao=editar&idModoProd={$modoProd->getIdModoProd()}'><i class='material-icons'>
                                                        create</i></a>";
                                                    //botão excluir
                                                    echo"<a class='btn btn-danger btn-simple btn-icon btn-sm'  
                                                    href='../controlador/ModoProdControlador.php?operacao=excluir&idModoProd={$modoProd->getIdModoProd()}'>
        ...
        <div class="modal fade" id="modalFiltro" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
		  <div class="modal-dialog" role="document">
			<div class="modal-content">
				<form id="formFiltroModoProd" action="ModoProdTabela.php?operacao=filtrar" 
					method="post">
